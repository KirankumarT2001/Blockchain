...
const MidtermVerify = () => {
  ...
  const { MidTermVerify } = Midterm();

  const onSubmit = async ({ farmer_name, cropname, area, progress, timeremaing }) => {
    await MidTermVerify(farmer_name, cropname, area, progress, timeremaing);
  };
