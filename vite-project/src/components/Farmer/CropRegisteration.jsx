...
const CropRegisteration = () => {
  ...
  const onSubmit = async ({ farmer_name, cropname, area, cultivation, timeforharvest, yieldperacre }) => {
    await cropRegister(farmer_name, cropname, area, cultivation, timeforharvest, yieldperacre);
  };
